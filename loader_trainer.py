...
# create a list containing the names of the models :
    ...
    name_NBTR='transformer_nhid1_{}'.format(storage)
    name_NBFC='transformer_nhid2_{}'.format(storage)
    name_TR='transformer_nhid3_{}'.format(storage)
    name_TRT2V='transformer_nhid4_{}'.format(storage)
